...
const AdminUsersRow = ({
  ...
  return (
    <>
      {/* Desktop Row */}
      <div className="hidden lg:flex items-center px-8 py-5 border-b border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800 hover:bg-gray-50 dark:hover:bg-gray-700 transition-all duration-300">
      ...
      {/* Mobile Card */}
      <div className="lg:hidden bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-3xl p-6 mb-4 shadow-sm hover:shadow-md transition">
        ...
        <div className="grid grid-cols-3 gap-4 text-center text-sm">
          <div className="bg-blue-50 dark:bg-blue-900/30 rounded-xl p-3">
            ...
            <p className="font-bold text-gray-800 dark:text-gray-200">{user.totalTasks || 0}</p>
          </div>
          <div className="bg-green-50 dark:bg-green-900/30 rounded-xl p-3">
            <FaCheckCircle className="text-green-600 mx-auto mb-1" />
            <p className="font-bold text-gray-800 dark:text-gray-200">{user.completedTasks || 0}</p>
          </div>
